#' A function that calculates and returns the ssr of all possible combinations of segments in a matrix form.
...
#' @return SSRMatrix The matrix that contains the sums of square residuals (SSR) of all possible segments for the given dataset
