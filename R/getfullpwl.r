#' A function that finds the "left hand side" equation for each node. In order the maintain continuity of the curve, the intercepts of the lines become the breakpoints.
#' @param pwl The right hand side pwl equations
#' @param data The data that is being approximated
#' @param constraint The constraint sets by the data, e.g. sigmoid function must pass through y = 0.5 at x = 0
#' @return The full set of pwl equations (letf and right side) of the data
